#!/usr/bin/env python3
###############################################################################
# Download C4 (Colossal Clean Crawled Corpus) dataset from HuggingFace
# Used for MaxText and TorchTitan pretraining
###############################################################################
...
def download_c4(
    ...
    """
    Download C4 dataset from HuggingFace.
    
    Args:
        output_dir: Directory to save the dataset
        subset: Dataset subset (default: "en" for English)
