#!/usr/bin/env python3
###############################################################################
# Tokenize dataset for Megatron-LM training
# Converts JSON/JSONL to binary .bin/.idx format
###############################################################################
...
class CustomLanguageVars(PunktLanguageVars):
    """Custom NLTK language vars that preserve empty lines."""
...
class IdentitySplitter:
    """Identity splitter that returns text as-is."""
    def tokenize(self, *text):
        return text


class Encoder:
    """Encoder for tokenizing documents."""
...
class IndexedDatasetBuilder:
    """Simple indexed dataset builder for Megatron format."""
