...
if [[ -z "${HF_TOKEN}" && -z "${HUGGINGFACE_HUB_TOKEN}" ]]; then
    echo "  x HF_TOKEN is not set. Llama 3.1 requires access to a gated repo."
    echo "    Set HF_TOKEN (or HUGGINGFACE_HUB_TOKEN) with a token that has access."
    exit 1
fi
...
if [ "$PROF_ENABLED" = "true" ]; then
    ...
    # Match the standard layout: profile_rocm_llama_PARALLEL.pt.trace.json
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    if [ $EXTRACT_EXIT -eq 0 ]; then
        ...
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo ""
        echo "1. Run additional benchmarks as needed:"
        echo "   ./benchmark.py --model $MODEL"
        echo ""
        echo "2. View enhanced metrics:"
